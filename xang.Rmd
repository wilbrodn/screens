---
title: "The best template so far"
subtitle: "⚔<br/>with xaringan"
author: "Copied from Yihui Xie"
...
output:
  xaringan::moon_reader:
    ...
    css: ["footer-header.css", "default", "kunoichi", "ninjutsu", "rladies-fonts", "w3.css"]
...
<div class="my-header">Made by PA. Ref: https://github.com/yihui/xaringan/wiki </div>


<div class="my-footer" style="max-width:100%">
  <div class="mySlidess w3-container w3-red">
    <h1><b>Did You Know?</b></h1>
    <h1><i>We plan to sell trips to the moon in the 2020s</i></h1>
  </div>

  <img class="mySlidess" src="img_monterosso.jpg" style="width:100%">

  <div class="mySlidess w3-container w3-xlarge w3-white w3-card-4">
    <p><span class="w3-tag w3-yellow">New!</span>
    <p>6 Crystal Glashhhhhhhhhhhhhhhhhhhhhses</p>
    <p>Only $99 !!!</p>
  </div>

  <img class="mySlidess" src="img_manarola.jpg" style="width:100%">
</div>
...
* [Importing from Microsoft PowerPoint](https://github.com/yihui/xaringan/wiki/Importing-from-Microsoft-PowerPoint)

* [Title slides etc.](https://github.com/yihui/xaringan/wiki/Title-slide)

* For no slide numbers: Add this to the css file: *.remark-slide-number { display: none; }*

A reference on gifs and animations: https://annakrystalli.me/talks/xaringan/xaringan.html#1

Continue lopping slides: https://gist.github.com/gadenbuie/aeb16bd1445bdc1e0294465f46e3de50

More on animations: https://github.com/yihui/xaringan/issues/184

To add videos, go here: https://stackoverflow.com/questions/58381602/background-video-in-xaringan-slides

Overall:https://bookdown.org/yihui/rmarkdown/xaringan.html


theme generator for r code and results: https://pkg.garrickadenbuie.com/xaringanthemer/articles/xaringanthemer.html
